...
const FrameComponent4: FunctionComponent = () => {
  return (
    <div className={styles.frameGlobalBrokerage}>
      <img
        className={styles.frameGlobalBrokerageChild}
        loading="eager"
        alt=""
        src="/group-2@2x.png"
      />
      <div className={styles.bookNowReadMore}>
        <img
          className={styles.bookNowReadMoreChild}
          alt=""
          src="/rectangle-14@2x.png"
        />
        <div className={styles.customersOfficesStudents}>
