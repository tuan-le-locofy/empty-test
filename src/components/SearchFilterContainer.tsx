  ...
  return (
    <div className={styles.searchFilters}>
      ...
      <div className={styles.bookingOptions}>
        ...
        <FormControlLabel
          className={styles.component1formcheckbox2}
          label="Book on Fickleflight"
          labelPlacement="end"
          control={<Checkbox size="medium" />}
        />
        <FormControlLabel
          className={styles.component1formcheckbox3}
      ...
      <div className={styles.flightExperience}>
        ...
        <FormControlLabel
          className={styles.component1formcheckbox4}
          label="No overnight flights"
          labelPlacement="end"
          control={<Checkbox color="primary" size="medium" />}
        />
        <FormControlLabel
          className={styles.component1formcheckbox5}
          label="No long stop-overs"
          labelPlacement="end"
          control={<Checkbox color="primary" size="medium" />}
        />
      </div>
      <img className={styles.seperatorIcon} alt="" src="/vector-2.svg" />
      <div className={styles.airlines}>
        <b className={styles.results4}>Airlines</b>
        <FormControlLabel
          className={styles.component1formcheckbox6}
          label="Singapore Airlines"
          labelPlacement="end"
          control={<Checkbox color="primary" size="medium" />}
        />
        <FormControlLabel
          className={styles.component1formcheckbox7}
          label="Qatar Airways"
          labelPlacement="end"
          control={<Checkbox color="primary" size="medium" />}
        />
